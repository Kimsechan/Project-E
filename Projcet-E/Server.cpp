...
int main()
{
	...
	//마지막으로 체크했을때 마이크로 세컨드가 어떻게 되었을까요
	...
	while (isRunning)
	{
		...
		//지난 시간은 이 정도 되요
		//마지막으로 체크했을때 999999 였다라고 생각을 해봅시다
		//마이크로 세컨드는 1000000 이 채워졌을 때 세컨드로 넘어갑니다 1초죠?
...
int StartServer(int currentFD)
{
	...
	if (SQLConnect() == 1)
	{
		//SQL연결은 안쪽에서 왜 안되었는지 이야기해줍니다 그래서 Cout 필요 없음
		return -1;
	};
